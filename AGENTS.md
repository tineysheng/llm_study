...
This repository is a guided learning project for a Go programmer studying LLM applications, RAG, AI Agents, and MCP.

Before helping with learning, code changes, planning, or review in this repository, read these files first:

1. `AI_TUTORING.md` - the user's preferred AI tutoring workflow and previous learning records
2. `README.md` - the overall learning roadmap
3. `PROGRESS.md` - the current stage and task checklist

Use the tutoring workflow from `AI_TUTORING.md`:

1. Design the current knowledge point
